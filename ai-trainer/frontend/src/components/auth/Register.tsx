...
export const Register = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Right Section - Register Form (33% on desktop, full on mobile) */}
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full text-white font-bold py-4 rounded-lg transition-all duration-200 uppercase text-sm tracking-wider shadow-button hover:shadow-card-hover mt-6 ${
                isLoading 
